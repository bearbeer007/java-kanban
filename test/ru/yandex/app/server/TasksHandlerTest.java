...
class TasksHandlerTest extends HttpTaskServerTest {
    ...
    void updateTask() throws IOException, InterruptedException {
        ...
        Task taskForUpdate = taskManager.getTaskByTaskId(taskId);
        ...
        taskForUpdate.setStatus(TaskStatus.DONE);
        ...
        HttpRequest request = HttpRequest.newBuilder()
            ...
            HttpResponse<String> response = client.send(request, HttpResponse.BodyHandlers.ofString());
            assertEquals(201, response.statusCode(), response.body());
            final Task updatedTask = taskManager.getTaskByTaskId(taskId);
            ...
            assertEquals(TaskStatus.DONE, updatedTask.getStatus(), "Статус задачи не совпадает");
    ...
    void getTaskById() throws IOException, InterruptedException {
        ...
        HttpRequest request = HttpRequest.newBuilder()
            ...
            assertEquals(taskId, taskFromHttp.getTaskId(), "Некорректный id задачи");
    ...
    @Test
    void getTaskWrongEndPoint() throws IOException, InterruptedException {
        HttpClient client = HttpClient.newHttpClient();
    ...
    @Test
    void addIntersectionsTasks() throws IOException, InterruptedException {
